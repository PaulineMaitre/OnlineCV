...
VALUES (1, 'Python', '../assets/logo_python.png', 3, 3);
INSERT INTO defaultdb.skill (id, skill_name, skill_logo_link, skill_level, user_id)
VALUES (2, 'PHP', '../assets/logo_php.png', 2, 3);
INSERT INTO defaultdb.skill (id, skill_name, skill_logo_link, skill_level, user_id)
VALUES (3, 'HTML', '../assets/logo_html.png', 4, 3);
INSERT INTO defaultdb.skill (id, skill_name, skill_logo_link, skill_level, user_id)
VALUES (4, 'CSS', '../assets/logo_css.png', 4, 3);
INSERT INTO defaultdb.skill (id, skill_name, skill_logo_link, skill_level, user_id)
VALUES (5, 'Java', '../assets/logo_java.png', 4, 3);

INSERT INTO defaultdb.socials (id, social_name, social_link, social_logo, user_id)
VALUES (1, 'LinkedIn','https://www.linkedin.com/in/paulinemaitre/','../assets/logo_linkedin.png', 3);
INSERT INTO defaultdb.socials (id, social_name, social_link, social_logo, user_id)
VALUES (2, 'Github','https://www.github.com/PaulineMaitre','../assets/logo_github.png', 3);
INSERT INTO defaultdb.socials (id, social_name, social_link, social_logo, user_id)
VALUES (3, 'GitLab','https://gitlab.com/PaulineMaitre','../assets/logo_gitlab.png', 3);
INSERT INTO defaultdb.socials (id, social_name, social_link, social_logo, user_id)
...
INSERT INTO defaultdb.frame_content (id, frame_title, frame_logo_url, frame_order, user_id)
VALUES (2, 'Experience','../assets/handshake.png', 2, 3);
